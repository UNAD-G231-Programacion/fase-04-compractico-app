...
# ── MÓDULO 1: ARQUITECTURA BASE Y GESTION DE CLIENTES (Autor: Andrés Maya) ────────
# (código de Andrés)


# ── MÓDULO 2: SERVICIOS ESPECIALIZADOS (Autor: Daniel Benavides) ───
...
# ── MÓDULO 3: CALCULO DE COSTOS (Autor: Sebastian Gonzales) ────────
# (código del Sebastian Gonzales)

# ── MÓDULO 4: RESERVAS (Autor: Johan Pérez) ────────
